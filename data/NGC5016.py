#! /usr/bin/env python
#
#  compare rotation curves for NGC5016 (see also the generic rotcmp1.py)
#
...
t18 = 'edge_pydb/edge_pydb/dat_prof/rotcur_leung/EDGE_CO_vrot/NGC5016_co_vrot.txt'
t19 = 'edge_pydb/edge_pydb/dat_prof/rotcur_leung/EDGE_CO_vrot_bsc/NGC5016_co_vrot.txt'
...
# deconvolved (graphical method, from Nate)
v0 = v1
r0 = 7.3
m0 = 1.85
# PJT thinks r0=8.0 m0=2.0
...
for f in bfiles:
    ...
    galrows = table[table['bbName']=='NGC5016']
    rt = galrows['bbRad']
    vt = galrows['bbVrot']
    it = galrows['bbInc']
    tmp = galrows['bbPA']
...
plt.plot(r1,vrot1,   '-o',c='black',label='rotcur inc=46')
...
plt.scatter(r18,v18 ,c='r',label='leung-18')
plt.scatter(r19,v19 ,c='r',label='leung-19')
...
plt.title('NGC5016 rotation curves, corrected to inc=46')
plt.xlabel('Radius')
plt.ylabel('Velocity')
plt.grid()
#plt.legend(loc='lower right',fontsize = 'small')
plt.legend(loc='lower right',prop={'size':8})
plt.savefig('NGC5016.pdf')
plt.show()
